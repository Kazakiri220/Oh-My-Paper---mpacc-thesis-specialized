...
|---|---|
| topic/proposal gate | `../mpacc-thesis-writer/references/topic-selection-framework.md`, `../mpacc-thesis-writer/references/proposal-and-litreview-deliverables.md` |
| outline | `../mpacc-thesis-writer/references/thesis-structure-and-patterns.md`, `../mpacc-thesis-writer/references/chapter-writing-rules.md` |
| chapter drafting | `../mpacc-thesis-writer/references/chapter-writing-rules.md`, plus method/theory/case references as needed |
| literature review | `../mpacc-thesis-writer/references/literature-review-method.md`, `../mpacc-thesis-writer/references/runtime-literature-selection.md` |
| citation plan or audit | `../mpacc-thesis-writer/references/runtime-literature-selection.md`, `../mpacc-thesis-writer/scripts/check_citations.py` |
| revision | `../mpacc-thesis-writer/references/problem-cause-solution-logic.md`, `../mpacc-thesis-writer/references/quality-checklist.md` |
