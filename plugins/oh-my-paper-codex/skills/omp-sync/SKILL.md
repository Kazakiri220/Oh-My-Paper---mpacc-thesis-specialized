---
name: omp-sync
description: "Synchronize Oh My Paper pipeline state, task records, and working memory. Use for state reconciliation; do not use to overwrite unresolved or conflicting project evidence."
---
